...
//        continue with out login in
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.google_signIn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                signIn();
                if (myloader.getVisibility() == View.GONE ){
...
//        Thread.sleep(1000);
//    Toast.makeText(this, e.getMessage()+" No Internet Connection ", Toast.LENGTH_SHORT).show();
//
//
//}
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            FirebaseUser user = mAuth.getCurrentUser();
                            Intent intent = new Intent(getApplicationContext(), EstablishmentListActivity.class);
